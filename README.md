...
2. Search for "AS Dark Theme" and install.
3. Open the Command Palette (Ctrl+Shift+P) and choose "Color Theme: Select Color Theme" → "AS Dark Theme".
...
- Contact Us at [Contact Support](mailto:AS.DeveloperSC@gmail.com)

## License

This theme is provided under the AS.Developer License. See the LICENSE file for details.

Thank you for trying AS Dark Theme — enjoy a focused and colorful coding experience.
